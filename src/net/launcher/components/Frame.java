...
public class Frame extends JFrame implements ActionListener, FocusListener
{
	...
	public static Button toGame = new Button("");
	public static Button toAuth = new Button("");
	public static Button toLogout = new Button("");
	public static Button toPersonal = new Button("Войти в ЛК");
	public Button toOptions = new Button("");
	...
	public Button options_close = new Button("");
