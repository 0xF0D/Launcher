...
{	
	...
	public static ComponentStyle	panelOpt	= new ComponentStyle(225, 105, 400, 300, "font", 16F, Color.WHITE, true);
	
	//public static CheckboxStyle		loadnews	= new CheckboxStyle(250, 180, 300, 23, "font", "checkbox", 16F, Color.DARK_GRAY, true);
	public static CheckboxStyle		updatepr	= new CheckboxStyle(250, 205, 300, 23, "font", "checkbox", 16F, Color.DARK_GRAY, true);
	public static CheckboxStyle		cleandir	= new CheckboxStyle(250, 230, 300, 23, "font", "checkbox", 16F, Color.DARK_GRAY, true);
	public static CheckboxStyle		fullscrn	= new CheckboxStyle(250, 255, 300, 23, "font", "checkbox", 16F, Color.DARK_GRAY, true);
	//public static CheckboxStyle		offline		= new CheckboxStyle(250, 280, 300, 23, "font", "checkbox", 16F, Color.DARK_GRAY, true);
	public static TextfieldStyle	memory		= new TextfieldStyle(240, 354, 250, 36, "memory", "font", 16F, Color.DARK_GRAY, Color.DARK_GRAY, new EmptyBorder(0, 10, 0, 10));
	public static ButtonStyle		close		= new ButtonStyle	(490, 350, 130, 42, "font", "exit", 16F, Color.RED, true, Align.CENTER);
